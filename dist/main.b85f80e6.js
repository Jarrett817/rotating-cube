...
function isTransFormed() {
  var transformed = cube.style.transform;

  if (transformed) {
    var array = transformed.split(' '); // 使用正则提取x,y的值
...
function Move() {
  window.addEventListener(isMobile ? 'touchstart' : 'mousedown', function (e) {
    //按下的坐标
    var down = {};
